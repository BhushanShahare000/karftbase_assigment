...
export default function ForLenders() {
    return (
        <section className="relative max-w-7xl mx-auto px-6 md:px-12 pt-16 pb-24 text-center z-[30]">
            <p className="text-blue-600 font-semibold mb-3 tracking-wide text-sm uppercase">For Lenders</p>
            <h2 className="text-[32px] md:text-[48px] font-bold leading-tight max-w-4xl mx-auto mb-20 text-center text-[#0f172a]">
                We're changing the game with{" "}
                <span className="bg-gradient-to-r from-blue-900 to-blue-950 bg-clip-text text-transparent">
                    one complete agency <br className="hidden md:block" /> management tool
                </span>
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14">
                <div className="p-8 md:p-10 rounded-[40px] bg-white shadow-[0_4px_40px_rgba(0,0,0,0.03)] relative overflow-hidden border border-white/60">
                    <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-[#0f172a]">
                        <span className="text-xl">💡</span> Intuitive & Agent Focused
                    </h3>
                    ...
                    <div className="relative mt-4 flex justify-center items-center h-[280px] md:h-[320px]">
                        <div className="absolute inset-0 bg-gradient-to-tr from-blue-50/50 via-white to-blue-100/40 rounded-[30px] blur-[2px]" />
                        ...
                        <div className="relative w-full h-full flex items-center justify-center scale-75 md:scale-100">
                            ...
                            <Image
                                ...
                                width={64}
                                height={64}
                                className="absolute bottom-4 right-[15%] z-[40] drop-shadow-xl rounded-full border-2 border-white animate-float"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className="p-8 md:p-10 rounded-[40px] bg-white shadow-[0_4px_40px_rgba(0,0,0,0.03)] relative overflow-hidden border border-white/60">
                    <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-[#0f172a]">
                        <span className="text-xl">⚙️</span> Highly Customizable
                    </h3>
                    <p className="text-gray-500 mb-10 leading-relaxed text-sm md:text-base max-w-md">
                        Our tool is designed with agencies & collection managers in mind,
                        ensuring user-friendly experience tailored to their needs.
                    ...
                    <div className="relative w-full rounded-[30px] bg-gradient-to-br from-blue-50/80 to-slate-100/60 border border-white/80 p-6 flex flex-col items-center min-h-[280px] md:min-h-[320px]">
                        ...
                        <div className="mt-4 z-10">
                            <span className="bg-blue-600 text-white text-sm font-bold px-6 py-2.5 rounded-full shadow-md shadow-blue-200">
                                API integration
                            </span>
                        </div>
                    </div>
                ...
                <div className="p-8 md:p-10 rounded-[40px] bg-white shadow-[0_4px_40px_rgba(0,0,0,0.03)] relative overflow-hidden border border-white/60">
                    <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-[#0f172a]">
                        <span className="text-xl">📊</span> Driven by Data
                    </h3>
                    <p className="text-gray-500 mb-10 leading-relaxed text-sm md:text-base max-w-md">
                    ...
                    <div className="flex gap-4 w-full items-start">
                        ...
                        <div className="flex flex-col gap-4 flex-1">
                            ...
                            <div className="flex items-center justify-center rounded-2xl border-2 border-dashed border-blue-200 bg-blue-50 hover:bg-blue-100 transition-colors cursor-pointer py-5">
                ...
                <div className="p-8 md:p-10 rounded-[40px] bg-white shadow-[0_4px_40px_rgba(0,0,0,0.03)] relative overflow-hidden border border-white/60">
                    <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-[#0f172a]">
                        <span className="text-xl">🤝</span> Discover Agency Partners
                    </h3>
                    <p className="text-gray-500 mb-10 leading-relaxed text-sm md:text-base max-w-md">
                    ...
                    <div className="relative w-full flex justify-center h-[280px] md:h-[320px]">
                        <div className="absolute left-0 top-0 w-[78%] md:w-[75%]" style={{ transform: "rotate(2deg)" }}>
                            <Image
                                src="/lenders5.png"
                                alt="Agency card"
                                width={300}
                        ...
                        <div className="absolute bottom-4 right-0 w-[55%] md:w-[50%]" style={{ transform: "rotate(-2deg)" }}>
                            <Image
                                src="/lenders6.png"
                                alt="Partner card"
                                width={200}
