...
export default function Hero() {
    return (
        <section>
            <section className="relative max-w-7xl mx-auto text-center pt-40 pb-32 px-6 md:px-12 z-[30]">
                {/* Badge */}
                ...
                {/* Heading */}
                <h1 className="relative text-[40px] md:text-[70px] font-semibold max-w-[900px] mx-auto mb-8 z-[40]">
                    Unified Platform for Late-Stage{" "}
                    <span className="text-blue-600">DPD Resolution.</span>
                </h1>

                {/* Paragraph */}
                <p className="max-w-2xl mx-auto text-gray-600 text-lg md:text-xl leading-relaxed mb-12 z-[40]">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20 z-[40]">
                    <button className="bg-linear-to-r from-[#1952F1] to-[#418DF8] text-white px-8 py-4 rounded-xl font-semibold text-lg hover:opacity-90 transition shadow-xl shadow-blue-600/20">
                        Get free Trial
                    </button>
                    <button className="bg-white border border-gray-200 text-gray-800 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-50 transition shadow-sm">
                        How We work
                    </button>
                </div>
            ...
            <section className="relative z-[50] bg-white/50 backdrop-blur-md border-t border-gray-100 py-12 mt-20">
                <div className="max-w-6xl mx-auto text-center">
                    <p className="text-gray-400 font-medium mb-8">
                        Join <span className="text-gray-900 font-semibold">4,000+</span> Companies Already Grow
                    </p>
                    <div className="flex flex-wrap justify-center items-center gap-10 md:gap-16 opacity-70 hover:opacity-100 transition-all duration-700 grayscale hover:grayscale-0">
                        <Image src="/bank1.png" alt="Partner" width={100} height={40} className="object-contain" />
                        <Image src="/bank2.png" alt="Partner" width={100} height={40} className="object-contain" />
                        <Image src="/bank3.png" alt="Partner" width={100} height={40} className="object-contain" />
                        <Image src="/bank4.png" alt="Partner" width={100} height={40} className="object-contain" />
                        <Image src="/bank5.png" alt="Partner" width={100} height={40} className="object-contain" />
                        <Image src="/bank6.png" alt="Partner" width={100} height={40} className="object-contain" />
                        <Image src="/bank7.png" alt="Partner" width={100} height={40} className="object-contain" />
                    </div>
                </div>
            </section>
